/*
  # Fix trigger to use payment_request as payment_method

  1. Changes
    - Update trigger function to use 'payment_request' instead of payment_method_used
    - This ensures consistency with the constraint

  2. Notes
    - payment_method_used can be things like 'Venmo', 'PayPal', which aren't in the constraint
    - Use 'payment_request' as the payment_method to track these payments
*/
